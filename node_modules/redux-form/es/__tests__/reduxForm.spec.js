...
var describeReduxForm = function describeReduxForm(name, structure, combineReducers, expect) {
  ...
  describe(name, function () {
    ...
    it('should not reinitialize values on remount if destroyOnMount is false', function () {
      ...
      var Container = function (_Component31) {
        _inherits(Container, _Component31);

        function Container() {
          _classCallCheck(this, Container);

          var _this41 = _possibleConstructorReturn(this, (Container.__proto__ || Object.getPrototypeOf(Container)).call(this));

          _this41.state = { showForm: true };
          return _this41;
        }
          ...
          value: function render() {
            ...
            return React.createElement(
              ...
              React.createElement(
                'button',
                { onClick: function onClick() {
                    return _this42.setState({ showForm: !showForm });
                  } },
                'Toggle Form'
              )
            );
