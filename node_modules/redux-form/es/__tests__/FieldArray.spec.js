...
var describeFieldArray = function describeFieldArray(name, structure, combineReducers, expect) {
  ...
  describe(name, function () {
          ...
          value: function render() {
            ...
            return React.createElement(
              ...
              React.createElement(
                'button',
                { onClick: function onClick() {
                    return _this16.setState({ foo: 'qux', bar: 'baz' });
                  } },
                'Change'
              )
            );
          ...
          value: function render() {
            ...
            return React.createElement(
              ...
              React.createElement(
                'button',
                { onClick: function onClick() {
                    return _this18.setState({ foo: 'qux', bar: 'baz' });
                  } },
                'Change'
              )
            );
    ...
    it('should rerender when items added or removed', function () {
      ...
      var renderFieldArray = createSpy(function (_ref2) {
    ...
    it('should rerender when array sync error appears or disappears', function () {
      ...
      var renderFieldArray = createSpy(function (_ref3) {
    ...
    it('should NOT rerender when a value changes', function () {
      ...
      var renderFieldArray = createSpy(function (_ref4) {
    ...
    it('should work with Fields', function () {
      ...
      var renderFields = createSpy(function (_ref11) {
        var foo = _ref11.foo;
        return React.createElement(
          'div',
          null,
      ...
      var component = createSpy(function (_ref12) {
